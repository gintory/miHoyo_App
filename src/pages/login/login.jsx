...
import { Menu, Dropdown, notification, Modal, Button, Tabs, Input } from 'antd';
            ...
            <Tabs defaultActiveKey="1" tabPosition='top'>
                <TabPane tab="登录" key="1">
                    <div className="login_form">
                        ...
                        <Button className='login_form_btn' type='primary' onClick={handleLogin}>登录</Button>
                    </div>
                </TabPane>
                <TabPane tab="注册" key="2">
                    <div className="login_form">
                        ...
                        <Button className='login_form_btn' type='primary' onClick={handleRegister}>注册</Button>
                    </div>
                </TabPane>
            </Tabs>
        </div>
